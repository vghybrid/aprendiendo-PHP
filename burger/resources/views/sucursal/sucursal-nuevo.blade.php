      ...
      <form id="form1" method="POST">
            <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                        ...
                        <input type="text" id="txtTel" name="txtTel" class="form-control" value="{{ $sucursal->telefono }}">
                  </div>
                  <div class="form-group col-lg-6">
                        <label>Link mapa: *</label>
                        <input type="text" id="txtMapa" name="txtMapa" class="form-control"value="{{ $sucursal->link_mapa }}" >
                  </div>
            </div>
