      ...
      <form id="form1" method="POST" enctype="multipart/form-data">
            <div class="row">
                  ...
                  <div class="form-group col-lg-6">
                        ...
                        <div>
                              <label>Precio:</label>
                              <input type="number" id="nmbPrecio" name="nmbPrecio" class="form-control" value="{{ $producto->precio }}">
                        </div>
                  </div>

                  <div class="form-group col-lg-6">
                        <label>Descripcion:</label>
                        <textarea id="txtDescripcion" name="txtDescripcion" class="form-control descripcion" value="{{ $producto->descripcion }}"></textarea>
                  </div>
